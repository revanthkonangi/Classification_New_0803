...
# MAGIC %pip install /dbfs/FileStore/MONITORING/tigerml_0.4.5_wheel/tigerml.pyspark.core-0.4.5-py3-none-any.whl
# MAGIC
...
sensitive_columns = dbutils.widgets.get("sensitive_columns").split(",")
